...
public class SwaggerConfig {
    ...
    public static String DEVELOPER = "MPP Gryffindor";
    public static String DEVELOPER_EMAIL = "developer@pasteit.com";
    public static String DEVELOPER_WEBSITE = "https://www.pasteit.com";
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.miu.pasteit.api"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("PasteIt Services")
                .version("1.0.0")
                .description("PasteIt REST APIS")
